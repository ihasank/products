			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a  href="products.php">Manage Products</a></li> <!-- Add class "current" to sub menu items also -->
                ...
                <li>
					...
					<ul>
						<li><a  class="current" href="manageorders.php">Manage Orders</a></li>
					</ul>
				</li>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="current">Manage</a></li> <!-- href must be unique and match the id of target div -->
